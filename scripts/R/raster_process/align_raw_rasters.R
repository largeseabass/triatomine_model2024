...
r1 <-raster("/your_path/Downloads/to-send/EXT.tif") #raster("/your_path/Downloads/ensemble_8GCMs_ssp585_2071_2100/ensemble_8GCMs_ssp585_2071_2100_bioclim/ensemble_8GCMs_ssp585_2071_2100_AHM.tif")
r2 <- raster("/your_path/Documents/data/resample_mask/historical/AHM.tif")
...
#file_save_path <-"/your_path/Desktop/EXT.tif"
