...
prepare_input_data_basic_old <- function(occ_raw_path,clim,maxent_result_dir,split_ratio=0.90){
  # input:
  # occ_raw_path: the path of the occurence data (in .csv format, with decimal longitude and latitude columns have column names 'DecimalLongitude',"DecimalLatitude")
...
number_replicate <- 10
top_file_dir <- "/your_path/Documents/GitHub/r_chagasM/output/pixel_nobuffer_off"
