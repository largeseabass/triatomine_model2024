...
number_replicate <- 10
top_file_dir <- "/your_path/Documents/GitHub/r_chagasM/output/rf/pixel_buffer_off" # add an rf layer
species_input_dir <-"/your_path/Documents/GitHub/r_chagasM/output/pixel_buffer_off"
